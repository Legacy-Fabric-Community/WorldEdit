...
public class FabricWorldEdit implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        workingDir = FabricLoader.getInstance().getConfigDirectory().toPath().resolve("worldedit");
    ...
    private ActionResult onLeftClickBlock(PlayerEntity playerEntity, World world, BlockPos blockPos, Direction direction) {
        if (shouldSkip() || world.isClient) {
    ...
    private ActionResult onRightClickBlock(PlayerEntity playerEntity, World world, HitResult blockHitResult) {
        if (shouldSkip() || world.isClient) {
            return ActionResult.PASS;
        }
        ...
        com.sk89q.worldedit.util.Direction direction = FabricAdapter.adaptEnumFacing(blockHitResult.direction);
    ...
    private TypedActionResult<ItemStack> onRightClickAir(PlayerEntity playerEntity, World world) {
        ItemStack stackInHand = playerEntity.getMainHandStack();
        if (shouldSkip() || world.isClient) {
