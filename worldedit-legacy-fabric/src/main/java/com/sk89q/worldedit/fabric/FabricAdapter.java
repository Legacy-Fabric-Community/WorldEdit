...
public final class FabricAdapter {
    ...
    public static Block adapt(BlockType blockType) {
        return Block.REGISTRY.get(new Identifier(blockType.getId()));
    }

    public static BlockType adapt(Block block) {
        return BlockTypes.get(Block.REGISTRY.getIdentifier(block).toString());
    }

    public static Item adapt(ItemType itemType) {
        return Item.REGISTRY.get(new Identifier(itemType.getId()));
    }

    public static ItemType adapt(Item item) {
        return ItemTypes.get(Item.REGISTRY.getIdentifier(item).toString());
    }
    ...
    public static BaseItemStack adapt(ItemStack itemStack) {
        ...
        return new BaseItemStack(adapt(itemStack.getItem()), tag, itemStack.count);
    }
